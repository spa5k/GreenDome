...
declare global {
  ...
  const TransliterationsTextEditionSelector: typeof import('./features/editions/components/TransliterationTextEditionSelect')['TransliterationsTextEditionSelector']
  const afterAll: typeof import('vitest')['afterAll']
  const afterEach: typeof import('vitest')['afterEach']
  const assert: typeof import('vitest')['assert']
  const baseline-circle: typeof import('~icons/ic/baseline-circle.tsx')['default']
  const beforeAll: typeof import('vitest')['beforeAll']
  const beforeEach: typeof import('vitest')['beforeEach']
  const bookmark: typeof import('~icons/majesticons/bookmark.tsx')['default']
  const buttonVariants: typeof import('./components/Elements/Button/Button')['buttonVariants']
  const calculate-sharp: typeof import('~icons/material-symbols/calculate-sharp.tsx')['default']
  const calendar-month: typeof import('~icons/mdi/calendar-month.tsx')['default']
  const chai: typeof import('vitest')['chai']
  const check-circle: typeof import('~icons/material-symbols/check-circle.tsx')['default']
  const client: typeof import('./utils/rspc')['client']
  const clock-time-eight: typeof import('~icons/mdi/clock-time-eight.tsx')['default']
  const close: typeof import('~icons/material-symbols/close.tsx')['default']
  const clsx: typeof import('./utils/classMerger')['clsx']
  const createRef: typeof import('react')['createRef']
  const credit-card: typeof import('~icons/ci/credit-card.tsx')['default']
  const cross2: typeof import('~icons/radix-icons/cross2.tsx')['default']
  const cross: typeof import('~icons/charm/cross.tsx')['default']
  ...
  const face-smile-beam: typeof import('~icons/fa6-solid/face-smile-beam.tsx')['default']
  ...
  const house-chimney-window: typeof import('~icons/fa6-solid/house-chimney-window.tsx')['default']
  const it: typeof import('vitest')['it']
  const kaaba: typeof import('~icons/fa-solid/kaaba.tsx')['default']
  const lazy: typeof import('react')['lazy']
  const loading: typeof import('~icons/eos-icons/loading.tsx')['default']
  const md-map: typeof import('~icons/ion/md-map.tsx')['default']
  const memo: typeof import('react')['memo']
  const moon-filled-loop: typeof import('~icons/line-md/moon-filled-loop.tsx')['default']
  const mosque: typeof import('~icons/fa6-solid/mosque.tsx')['default']
  const mushaf: typeof import('./features/mushaf/api/index')['mushaf']
  const outline-check: typeof import('~icons/ic/outline-check.tsx')['default']
  const quran: typeof import('~icons/fa-solid/quran.tsx')['default']
  const round-keyboard-arrow-left: typeof import('~icons/ic/round-keyboard-arrow-left.tsx')['default']
  const round-keyboard-arrow-right: typeof import('~icons/ic/round-keyboard-arrow-right.tsx')['default']
  const search2-line: typeof import('~icons/ri/search2-line.tsx')['default']
  const search3-fill: typeof import('~icons/mingcute/search3-fill.tsx')['default']
  const settings-sharp: typeof import('~icons/ion/settings-sharp.tsx')['default']
  const sharp-check: typeof import('~icons/ic/sharp-check.tsx')['default']
  const sharp-settings: typeof import('~icons/ic/sharp-settings.tsx')['default']
  const slack-hash: typeof import('~icons/la/slack-hash.tsx')['default']
  const startTransition: typeof import('react')['startTransition']
  const suite: typeof import('vitest')['suite']
  const sunny-filled-loop-to-moon-alt-filled-loop-transition: typeof import('~icons/line-md/sunny-filled-loop-to-moon-alt-filled-loop-transition.tsx')['default']
  const sunny-filled-loop: typeof import('~icons/line-md/sunny-filled-loop.tsx')['default']
  ...
  const user-heart-line: typeof import('~icons/ri/user-heart-line.tsx')['default']

...
declare global {
	...
	const queryClient: typeof import('./utils/rspc')['queryClient'];
	const rspc: typeof import('./utils/rspc')['rspc'];
	...
	const useRspcMutation: typeof import('./utils/rspc')['useRspcMutation'];
	const useRspcQuery: typeof import('./utils/rspc')['useRspcQuery'];

import { CalculationMethodEnum, GeoLocationInfo } from '@/features/salah';
...
export const getPrayerTimes = (latitude: number, longitude: number, madhab?: typeof Madhab, calculationMethod?: CalculationMethodEnum) => {
	...
	const prayerTimes = [{ prayer: 'Fajr', time: times.fajr }, { prayer: 'Dhuhr', time: times.dhuhr }, { prayer: 'Asr', time: times.asr }, {
		prayer: 'Maghrib',
		time: times.maghrib,

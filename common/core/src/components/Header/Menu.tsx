...
export function Menu() {
	...
	return (
		<Menubar className='rounded-none border-b-2 pl-2 lg:pl-3'>
			<Link className='flex items-center' href='/'>
				<Icon icon='line-md:moon-filled-loop' className='h-8 w-8 fill-current' style={{ minWidth: '2rem' }} />
			</Link>

			<MenubarMenu>
				<MenubarTrigger className='ml-4 font-bold'>Quran</MenubarTrigger>
				<MenubarContent>
			...
			<MenuButtons />
			{isTauri && (
				<WindowControls closeWindow={closeWindow} maximizeWindow={maximizeWindow} minimizeWindow={minimizeWindow} />
			)}
		</Menubar>
	);
}

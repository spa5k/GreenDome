import { CommandGroup, CommandItem, Label, RadioGroup, RadioGroupItem } from '@quran/elements';
import { Edition } from '../../..';
import { useQuranTrackedStore } from '..';
	...
	return (
		<CommandGroup heading='Quran Font'>
			<RadioGroup defaultValue='option-one'>
				{quranTextFontEditions?.map((edition: Edition) => (
					<CommandItem
						key={edition.name}
						value={edition.name}
						onSelect={() => {
